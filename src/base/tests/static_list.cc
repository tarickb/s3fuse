...
std::string str_fn_1(const char *a)
{
  return "str fn 1";
}

std::string str_fn_2(const char *a)
{
  return "str fn 2";
}

std::string double_fn_1(double a)
{
  return "double fn 1";
}

std::string double_fn_2(double a)
{
  return "double fn 2";
}

std::string double_fn_3(double a)
{
  return "double fn 3";
}
